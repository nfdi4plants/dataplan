msca_dmp = {"msca-dmp" : `<div id="msca-dmp" class="">
    <div id="msca-dmp1" class="content-page" id="text_start">
        <span class="c2">Research data management and management of other research outputs</span>
        <ul class="c0 ">

            <li class="c0 li-bullet-0"><span class="c0">Types of data/research outputs and their estimated size; if applicable, combination with, and provenance of, existing data.<br>
             &ndash; $_PROJECTNAME will collect and/or generate the following types of raw data: #if$_GENETIC genetic data, #endif$_GENETIC  
            ...
            <li class="c0 li-bullet-0"><span class="c0">Findability of data/research outputs: Types of persistent and unique identifiers (e.g. digital object identifiers) and trusted repositories that will be used. 
            <br> &ndash;&nbsp; <span class="c1">
                All datasets will be associated with unique identifiers and will be annotated with metadata. We will
                use Investigation, Study, Assay (ISA) specification for metadata creation.  #if$_DATAPLANT The core integration with DataPLANT will also allow
            ...
            <li class="c0 li-bullet-0"><span class="c0">Accessibility of data/research outputs: IPR considerations and timeline for open access; provisions for access to restricted data for verification purposes. 
             <p class="c0">
                         <span class="c0">
                    ...
                    complete.
                        ...
                        <span class="c1">
                            &ndash; Data will be made available via the $_PROJECTNAME platform or a public platform using a user-friendly frontend that allows data visualization. Besides this it will be ensured that data which can be
                            stored in international discipline related repositories which use specialized technologies:
                            <p class="c0">
                                 #if$_GENETIC|$_GENOMIC|$_RNASEQ For genetic or genomic data: #if$_GENBANK NCBI-GenBank, #endif$_GENBANK #if$_ENA EBI-ENA, #endif$_ENA #endif$_GENETIC|$_GENOMIC|$_RNASEQ #if$_GENETIC #if$_SRA NCBI-SRA (Sequence Read Archive), #endif$_SRA #if$_ARRAYEXPRESS EBI-ArrayExpress, #endif$_ARRAYEXPRESS
        ...
        <ul class="c0 ">
            ...
            <li class="c0 li-bullet-0"><span class="c0">Interoperability of data/research outputs: Standards, formats and vocabularies for data and metadata. <br> &ndash; 
            ...
            Whenever possible, data will be stored in common and openly defined formats including all the necessary metadata. By
                    ...
                    Annotated Research Context (ARC) components#endif$_DATAPLANT. In addition, text files might be edited in text processor files, but will be shared as pdf.
                    </span>
                </li>



        <li class="c0 li-bullet-0"><span class="c0">Reusability of data/research outputs: Licenses for data sharing and re-use (e.g. Creative Commons, Open Data Commons); availability of tools/software/models for data generation and validation/interpretation /re-use.<br>
           ...
           Our data will be made freely available in the public domain to permit the widest re-use
            ...
            <li class="c0 li-bullet-0"><span class="c0">Curation and storage/preservation costs; person/team responsible for data management and quality assurance.<br>  <p class="c0"><span class="c1">The data related cost of $_PROJECTNAME are covered by the project funding.
