            ...
            <li class="c0 li-bullet-0">
                <span class="c1">
                    ...
                    &ndash; list-dataCollection-en
                        ...
                        <span class="c1">text-data-size-en
                ...
                <li class="c0 li-bullet-0">
                    <span class="c1">
                        ...
                        #if$_DATAPLANT The
                        core integration with DataPLANT will also allow individual releases to be tagged with a Digital Object Identifier (DOI).
                        #endif$_DATAPLANT 
                    </span>
                        </span>
                    </li>
                ...
                <li class="c0 li-bullet-0">
                    ...
                    text-dataplant-tools-en
                        ...
                        <li class="c0 li-bullet-0">
                            <span class="c1">
                   <b>Curation and storage/preservation costs; person/team responsible for data management and quality assurance.</b>
                <span class="c1"> <br> &ndash; text-cost-en </span>
                    </span>
                </li>
            </div>
        </div>`}