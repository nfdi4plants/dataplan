// Auto-generated from maDMP-schema-1.2.json
// Defines window.MADMP_SCHEMA_V12 for browser code.
window.MADMP_SCHEMA_V12 = {
  ...
  "$defs": {
    ...
    "AffiliationID": {
      "$anchor": "AffiliationID",
      "type": "object",
      "title": "Affiliation ID",
      "properties": {
        "identifier": {
          "$ref": "#/$defs/AffiliationIDValue"
        },
        "type": {
          "$ref": "#/$defs/AffiliationIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "AffiliationIDType": {
      ...
      "title": "Affiliation ID Type",
      "description": "Identifier type. Allowed values: ror, grid, isni, other",
      "examples": [
        "ror"
      ]
    },
    "AffiliationIDValue": {
      "$anchor": "AffiliationIDValue",
      "type": "string",
      "title": "Affiliation ID Value",
      "examples": [
    ...
    "ContactID": {
      ...
      "properties": {
        "identifier": {
          "$ref": "#/$defs/ContactIDValue"
        },
        "type": {
          "$ref": "#/$defs/ContactIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "ContactIDValue": {
      "$anchor": "ContactIDValue",
      "type": "string",
      "title": "Contact ID Value",
      "examples": [
    ...
    "ContributorID": {
      "$anchor": "ContributorID",
      "type": "object",
      "title": "Contributor ID",
      "properties": {
        "identifier": {
          "$ref": "#/$defs/ContributorIDValue"
        },
        "type": {
          "$ref": "#/$defs/ContributorIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "ContributorIDValue": {
      "$anchor": "ContributorIDValue",
      "type": "string",
      "title": "Contributor ID Value",
      "examples": [
        "https://orcid.org/0000-0003-0644-4174"
      ]
    },
    "ContributorRole": {
      "$anchor": "ContributorRole",
      "type": "string",
    ...
    "CreatorID": {
      ...
      "properties": {
        "identifier": {
          "$ref": "#/$defs/CreatorIDValue"
        },
        "type": {
          "$ref": "#/$defs/CreatorIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "CreatorIDValue": {
      "$anchor": "CreatorIDValue",
      "type": "string",
      "title": "Creator ID Value",
      "examples": [
        "https://orcid.org/0000-0003-0644-4174"
      ]
    },
    ...
    "DatasetID": {
      ...
      "properties": {
        "identifier": {
          "$ref": "#/$defs/DatasetIDValue"
        },
        "type": {
          "$ref": "#/$defs/DatasetIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "DatasetIDValue": {
      "$anchor": "DatasetIDValue",
      "type": "string",
      "title": "Dataset ID Value",
    ...
    "FunderID": {
      ...
      "properties": {
        "identifier": {
          "$ref": "#/$defs/FunderIDValue"
        },
        "type": {
          "$ref": "#/$defs/FunderIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "FunderIDValue": {
      "$anchor": "FunderIDValue",
      "type": "string",
      "title": "Funder ID Value",
    ...
    "MetadataStandardID": {
      "$anchor": "MetadataStandardID",
      "type": "object",
      "title": "Metadata Standard ID",
      "properties": {
        "identifier": {
          "$ref": "#/$defs/MetadataStandardIDValue"
        },
        "type": {
          "$ref": "#/$defs/MetadataStandardIDType"
        }
      },
      "required": [
        "identifier",
    ...
    "MetadataStandardIDType": {
      "$anchor": "MetadataStandardIDType",
      "type": "string",
      "enum": [
        "url",
        "other"
      ],
      "title": "Metadata Standard ID Type",
      "description": "Identifier type. Allowed values: url, other",
      "examples": [
        "url"
      ]
    ...
    "MetadataStandardIDValue": {
      "$anchor": "MetadataStandardIDValue",
      "type": "string",
      "title": "Metadata Standard ID Value",
